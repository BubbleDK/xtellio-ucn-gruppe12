            ...
            <div class="flex w-full items-center justify-between bg-white dark:bg-gray-800 px-8 py-4 border-l-4 border-green-500 dark:border-green-300">
              ...
              <div class="flex justify-center">
                <div class="flex justify-center">
                  ...
                  <span v-if="key === ''" class="ml-2 text-sm text-gray-600 dark:text-gray-300 capitalize">Unknown</span>
                  <span v-else class="ml-2 text-sm text-gray-600 dark:text-gray-300 capitalize">
                    {{ key }}
                  </span>
                </div>
